...
#define NNPR_OBJ    @"hp10c-orig"                              // Added 8/8/2022, telemark software®
#define NNPR_STATE  @"state.nonpareil-10c"
#define NNPR_RAM    40
...
#define NNPR_OBJ    @"hp11c-orig"                              // Added 8/8/2022, telemark software®
...
#define NNPR_OBJ	@"hp12c-orig"                              // Added 8/8/2022, telemark software®
...
#define NNPR_OBJ    @"hp12c-orig"                              // Added 8/8/2022, telemark software®
#define NNPR_STATE  @"state.nonpareil-12cp"
#define NNPR_RAM    40
#define NNPR_CLOCK  215000.0
#define NNPR_WSIZE  56.0
...
#define NNPR_OBJ	@"hp15c-orig"                              // Added 8/8/2022, telemark software®
...
#define NNPR_OBJ	@"hp16c-orig"               // Added by Mark H. Shin.  Copyright © 2022 telemark software®
...
@property bool keyClick;                        // Added by Mark H. Shin.  Copyright © 2022 telemark software®
@property bool displayBlink;                    // Added by Mark H. Shin.  Copyright © 2022 telemark software®
@property int contrast;							// Added by Mark H. Shin.  Copyright © 2022 telemark software®
